...
export default function UsrProfile() {
  ...
  return (
    <div className="bg-background h-[1500px]">
      <div className="mx-auto  max-w-7xl px-4 sm:px-6 lg:px-8 mb-5 ">
        ...
        <div className="border-t border-primary px-4 py-6 sm:px-6">
          <button
            ...
            type="submit"
            className="rounded-md  mb-8 bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:text-text focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            Add Address
          </button>
          {showAddAddressForm ? (
            <form
              className=" px-5 py-12 mt-1"
              noValidate
          ...
          {user.addresses.map((address, index) => (
            <div>
              {selectedEditIndex === index ? (
                <form
                  className="bg-background px-5 py-12 mt-1"
                  noValidate
                  onSubmit={handleSubmit((data) => {
                    console.log(data);
                    handleEdit(data);
              ...
              <div className="flex justify-between gap-x-6 px-5 py-6 mt-4 border-solid border-2 border-accent">
                ...
                <div className="flex flex-col  gap-2 items-center justify-center sm:flex sm:flex-col sm:items-end ">
                  <button
                    // to="/address-edit"
                    onClick={() => handleEditForm(index)}
                    type="button"
                    className="font-normal hover:bg-secondary px-3 py-2 rounded-xl text-text uppercase sm:text-sm "
                  >
                    Edit
                  </button>
                  <button
                    ...
                    type="button"
                    className="font-normal text-text hover:bg-secondary px-3 py-2 rounded-xl uppercase sm:text-sm"
                  >
                    Remove
                  </button>
                </div>
